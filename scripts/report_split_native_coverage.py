#!/usr/bin/env python3
"""Report split-native coverage against the frozen upstream snapshot."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--manifest",
        default="docs/reference/split-native-coverage-manifest.json",
    )
    parser.add_argument(
        "--fail-under",
        type=float,
    ...
    for entry in entries:
        ...
        for relative in entry["binding_files"] + entry["native_files"]:
        ...
        resolved_entries.append(
            {
                ...
                "binding_files": entry["binding_files"],
